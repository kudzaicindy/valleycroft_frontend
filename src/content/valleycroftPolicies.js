/** Guest-facing copy — BnB and cancellation (landing + booking flow). */
...
/** In-app anchor (e.g. booking flow section id="policies"). */
export const VALLEYCROFT_POLICIES_URL = VALLEYCROFT_POLICIES_HASH;
