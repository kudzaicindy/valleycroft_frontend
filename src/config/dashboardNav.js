    ...
    sections: [
      {
        ...
        items: [
          ...
          { icon: 'fas fa-credit-card', label: 'Payments', path: 'payments' },
...
export const pageDescriptions = {
  admin: {
    ...
    payments: "Record guest cash or bank receipts against confirmed bookings (posts to Finance)",
  ...
  finance: {
    ...
    staff: "Record wage and salary payments to workers; view payout history",
    salary: "Record wage and salary payments to workers; view payout history",
    suppliers: "Supplier list, add payment, payment history per supplier",
    debtors: "Outstanding debtors and aging — record guest receipts on Payments",
